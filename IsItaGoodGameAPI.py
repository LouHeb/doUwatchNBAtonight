...
if LastDay!=Today:
    ...
    for league in Leagues:    
        ...
        StudiedGames = leaguegamefinder.LeagueGameFinder(player_or_team_abbreviation='T',date_from_nullable = LastDay,date_to_nullable = Today, league_id_nullable = ligId[league], outcome_nullable = "W")
